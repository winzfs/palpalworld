...
export const REGION_CATALOG = {
  starter_meadow: {
    ...
    resourceTypes: ["wood", "stone", "fiber", "berry", "herb"],
    creatureSpeciesIds: ["leafbun", "sparkit", "droplet"],
    description: "초보 모험가가 처음 정착하는 안전한 초원 지역.",
  },
  moss_forest: {
    id: "moss_forest",
    name: "이끼숲",
    recommendedLevel: [6, 15],
    resourceTypes: ["wood", "hardwood", "fiber", "herb", "berry"],
    creatureSpeciesIds: ["leafbun", "mossboar", "shadowcat"],
    description: "나무와 약초가 풍부하지만 밤에는 어둠속성 몬스터가 출몰한다.",
  },
  stone_hills: {
    id: "stone_hills",
    name: "돌무지 언덕",
    recommendedLevel: [10, 22],
    resourceTypes: ["stone", "ore", "coal"],
    creatureSpeciesIds: ["rockturtle", "moleminer", "sparkit"],
    description: "광석과 석탄이 풍부한 채광 중심 지역.",
  },
  ember_desert: {
    id: "ember_desert",
    name: "불씨 사막",
    recommendedLevel: [18, 32],
    resourceTypes: ["stone", "ore", "coal", "ember_shard"],
    creatureSpeciesIds: ["flametail", "cinderscorp", "rockturtle"],
    description: "고열 환경과 불속성 몬스터가 지배하는 사막.",
  },
  frost_peaks: {
    id: "frost_peaks",
    name: "서리 봉우리",
    recommendedLevel: [28, 45],
    resourceTypes: ["stone", "ore", "ice_crystal"],
    creatureSpeciesIds: ["snowpuff", "frosthorn", "shadowcat"],
    description: "방한 장비와 냉각 작업 몬스터가 중요한 고난도 지역.",
  },
...
export const RESOURCE_CATALOG = {
  wood: {
    ...
    respawnMs: 30_000,
    harvestTool: "axe",
    drops: [{ itemId: "wood", min: 8, max: 14, chance: 1 }],
  },
  hardwood: {
    type: "hardwood",
    name: "단단한 나무",
    ...
    harvestTool: "axe",
    drops: [
      { itemId: "wood", min: 6, max: 10, chance: 1 },
      { itemId: "hardwood", min: 3, max: 7, chance: 0.75 },
    ],
  },
  stone: {
    type: "stone",
    ...
    respawnMs: 30_000,
    harvestTool: "pickaxe",
    drops: [{ itemId: "stone", min: 8, max: 12, chance: 1 }],
  },
  fiber: {
    type: "fiber",
    name: "풀섬유",
    ...
    respawnMs: 20_000,
    harvestTool: "sickle",
    drops: [{ itemId: "fiber", min: 5, max: 9, chance: 1 }],
  },
  ore: {
    type: "ore",
    name: "광맥",
    ...
    harvestTool: "pickaxe",
    drops: [
      { itemId: "stone", min: 3, max: 6, chance: 1 },
      { itemId: "ore", min: 4, max: 8, chance: 0.9 },
    ],
  },
  berry: {
    type: "berry",
    ...
    baseAmount: 40,
    respawnMs: 25_000,
    drops: [{ itemId: "berry", min: 4, max: 8, chance: 1 }],
  },
  herb: {
    type: "herb",
    name: "약초",
    baseAmount: 35,
    respawnMs: 25_000,
    drops: [{ itemId: "herb", min: 3, max: 6, chance: 1 }],
  },
  coal: {
    type: "coal",
    name: "석탄맥",
    ...
    respawnMs: 55_000,
    harvestTool: "pickaxe",
    drops: [{ itemId: "coal", min: 4, max: 8, chance: 1 }],
  },
  ice_crystal: {
    type: "ice_crystal",
    name: "얼음 결정석",
    ...
    respawnMs: 70_000,
    harvestTool: "pickaxe",
    drops: [{ itemId: "ice_crystal", min: 2, max: 5, chance: 1 }],
  },
  ember_shard: {
    type: "ember_shard",
    name: "불씨 결정석",
    ...
    respawnMs: 70_000,
    harvestTool: "pickaxe",
    drops: [{ itemId: "ember_shard", min: 2, max: 5, chance: 1 }],
  },
...
export const CREATURE_CATALOG = {
  leafbun: {
    ...
    baseDefense: 5,
    baseMoveSpeed: 110,
    workSkills: { farming: 1, hauling: 1 },
    drops: [
      { itemId: "leaf_pelt", min: 1, max: 2, chance: 0.8 },
      { itemId: "berry", min: 1, max: 3, chance: 0.35 },
    ],
  },
  flametail: {
    id: "flametail",
    ...
    baseDefense: 6,
    baseMoveSpeed: 125,
    workSkills: { cooking: 2, crafting: 1 },
    drops: [
      { itemId: "flame_tail", min: 1, max: 2, chance: 0.75 },
      { itemId: "ember_shard", min: 1, max: 1, chance: 0.2 },
    ],
  },
  droplet: {
    id: "droplet",
    ...
    baseDefense: 8,
    baseMoveSpeed: 80,
    workSkills: { farming: 1, cooling: 1 },
    drops: [{ itemId: "water_jelly", min: 1, max: 3, chance: 0.9 }],
  },
  sparkit: {
    id: "sparkit",
    name: "전기쥐",
    ...
    baseDefense: 5,
    baseMoveSpeed: 135,
    workSkills: { generating: 2, hauling: 1 },
    drops: [{ itemId: "spark_core", min: 1, max: 2, chance: 0.65 }],
  },
  rockturtle: {
    id: "rockturtle",
    name: "돌거북",
    ...
    baseDefense: 18,
    baseMoveSpeed: 55,
    workSkills: { mining: 3, hauling: 1 },
    drops: [
      { itemId: "stone", min: 4, max: 10, chance: 1 },
      { itemId: "ore", min: 1, max: 3, chance: 0.4 },
    ],
  },
  mossboar: {
    id: "mossboar",
    ...
    baseDefense: 12,
    baseMoveSpeed: 95,
    workSkills: { logging: 2, farming: 1 },
    drops: [{ itemId: "hardwood", min: 2, max: 5, chance: 0.8 }],
  },
  shadowcat: {
    id: "shadowcat",
    name: "그림자고양이",
    ...
    baseDefense: 7,
    baseMoveSpeed: 160,
    workSkills: { scouting: 3 },
    drops: [{ itemId: "pal_essence", min: 1, max: 2, chance: 0.5 }],
  },
  moleminer: {
    id: "moleminer",
    name: "광석두더지",
    ...
    workSkills: { mining: 3 },
    drops: [
      { itemId: "ore", min: 3, max: 7, chance: 0.9 },
      { itemId: "coal", min: 1, max: 3, chance: 0.35 },
    ],
  },
  cinderscorp: {
    id: "cinderscorp",
    ...
    baseDefense: 18,
    baseMoveSpeed: 105,
    workSkills: { generating: 1, defending: 2 },
    drops: [{ itemId: "ember_shard", min: 2, max: 6, chance: 0.85 }],
  },
  snowpuff: {
    id: "snowpuff",
    name: "눈송이펄",
    ...
    baseDefense: 10,
    baseMoveSpeed: 90,
    workSkills: { cooling: 2 },
    drops: [{ itemId: "ice_crystal", min: 1, max: 3, chance: 0.6 }],
  },
  frosthorn: {
    id: "frosthorn",
    name: "서리뿔사슴",
    ...
    baseDefense: 16,
    baseMoveSpeed: 135,
    workSkills: { cooling: 3, hauling: 1 },
    drops: [
      { itemId: "ice_crystal", min: 3, max: 8, chance: 0.9 },
      { itemId: "pal_essence", min: 1, max: 2, chance: 0.4 },
    ],
  },
...
export const CRAFTING_RECIPES = {
  basic_axe: {
    ...
    outputs: [{ itemId: "basic_axe", amount: 1 }],
    craftTimeMs: 2_000,
  },
  basic_pickaxe: {
    id: "basic_pickaxe",
    ...
    outputs: [{ itemId: "basic_pickaxe", amount: 1 }],
    craftTimeMs: 2_000,
  },
  capture_orb: {
    id: "capture_orb",
    ...
    outputs: [{ itemId: "capture_orb", amount: 3 }],
    craftTimeMs: 3_000,
  },
  workbench_kit: {
    id: "workbench_kit",
    ...
    outputs: [{ itemId: "workbench_kit", amount: 1 }],
    craftTimeMs: 1_500,
  },
  base_core_kit: {
    id: "base_core_kit",
    ...
    inputs: [
      ...
      { itemId: "pal_essence", amount: 3 },
    ],
    outputs: [{ itemId: "base_core_kit", amount: 1 }],
    craftTimeMs: 5_000,
  },
...
export const BUILDING_CATALOG = {
  base_core: {
    ...
    maxHp: 800,
    requires: [{ itemId: "base_core_kit", amount: 1 }],
    unlockLevel: 1,
    description: "개인 거점의 중심. 주변에 건물을 배치할 수 있다.",
  },
  storage_box: {
    type: "storage_box",
    name: "보관함",
    ...
    maxHp: 250,
    requires: [{ itemId: "wood", amount: 25 }],
    unlockLevel: 1,
    description: "자원과 아이템을 보관한다.",
  },
  workbench: {
    type: "workbench",
    name: "작업대",
    ...
    maxHp: 300,
    requires: [{ itemId: "workbench_kit", amount: 1 }],
    unlockLevel: 1,
    description: "도구와 포획구를 제작한다.",
  },
  pal_bed: {
    type: "pal_bed",
    name: "펄 침대",
    ...
    requires: [
      { itemId: "wood", amount: 10 },
      { itemId: "fiber", amount: 12 },
    ],
    unlockLevel: 2,
    description: "거점 몬스터의 피로도를 회복한다.",
  },
  farm_plot: {
    type: "farm_plot",
    name: "작은 밭",
    ...
    requires: [
      { itemId: "wood", amount: 12 },
      { itemId: "berry", amount: 6 },
    ],
    unlockLevel: 2,
    description: "열매와 약초를 재배한다.",
  },
  furnace: {
    type: "furnace",
    name: "화로",
  ...
  campfire: {
    ...
    unlockLevel: 1,
    description: "간단한 요리와 야간 시야 확보에 사용한다.",
  },
  wood_wall: {
    type: "wood_wall",
    name: "나무 벽",
    size: { width: 1, height: 1 },
    maxHp: 180,
    requires: [{ itemId: "wood", amount: 6 }],
    unlockLevel: 1,
    description: "거점 방어용 기본 벽.",
  },
  wood_floor: {
    type: "wood_floor",
    name: "나무 바닥",
    size: { width: 1, height: 1 },
    maxHp: 120,
    requires: [{ itemId: "wood", amount: 4 }],
    unlockLevel: 1,
    description: "건물 배치용 바닥 타일.",
  },
