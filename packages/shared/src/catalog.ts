...
export const TRAIT_CATALOG = {
  nimble: {
    ...
    target: "creature",
    rarity: "common",
    effects: [{ type: "move_speed_multiplier", value: 1.08 }],
    description: "이동 속도가 조금 증가한다.",
  },
  sturdy: {
    id: "sturdy",
    name: "튼튼한",
  ...
  hard_worker: {
    ...
    target: "creature",
    rarity: "uncommon",
    effects: [{ type: "work_speed_multiplier", value: 1.15 }],
    description: "거점 작업 속도가 증가한다.",
  },
  brave: {
    id: "brave",
    name: "용감한",
    target: "creature",
    rarity: "uncommon",
    effects: [{ type: "attack_multiplier", value: 1.12 }],
  ...
  tireless: {
    ...
    target: "creature",
    rarity: "rare",
    effects: [{ type: "stamina_multiplier", value: 1.25 }],
    description: "탈것/작업 스태미나가 증가한다.",
  },
  giant_body: {
    id: "giant_body",
    name: "거대한 체구",
    ...
    rarity: "rare",
    effects: [
      { type: "max_hp_multiplier", value: 1.2 },
      { type: "move_speed_multiplier", value: 0.94 },
    ],
    description: "체력이 크게 늘지만 이동 속도가 조금 감소한다.",
  },
  flame_attuned: {
    id: "flame_attuned",
    name: "화염 친화",
    target: "creature",
    rarity: "rare",
    effects: [{ type: "element_damage_bonus", value: 1.15, element: "fire" }],
    description: "불속성 공격 효율이 증가한다.",
  },
  frost_attuned: {
    id: "frost_attuned",
    name: "빙결 친화",
    target: "creature",
    rarity: "rare",
    effects: [{ type: "element_damage_bonus", value: 1.15, element: "ice" }],
    description: "얼음속성 공격 효율이 증가한다.",
  },
  lucky: {
    id: "lucky",
    name: "행운아",
    ...
    rarity: "epic",
    effects: [
      { type: "capture_bonus", value: 1.12 },
      { type: "work_speed_multiplier", value: 1.08 },
    ],
    description: "포획/작업 관련 보너스를 제공하는 희귀 특성이다.",
  },
...
export const ITEM_CATALOG = {
  ...
  leafbun_saddle: { id: "leafbun_saddle", name: "풀토끼 안장", category: "mount_gear", maxStack: 1 },
  mossboar_saddle: { id: "mossboar_saddle", name: "이끼멧돼지 안장", category: "mount_gear", maxStack: 1 },
  frosthorn_saddle: { id: "frosthorn_saddle", name: "서리뿔 안장", category: "mount_gear", maxStack: 1 },
