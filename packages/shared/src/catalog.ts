...
function node(id: string, regionId: string, resourceType: string, x: number, y: number, amount = 100): ResourceNodeState {
  return { id, regionId, resourceType, position: { x, y }, remainingAmount: amount, maxAmount: amount } as ResourceNodeState;
}

export const STARTER_RESOURCE_NODES: ResourceNodeState[] = [
  node("res-starter_meadow-0-0-wood-1", "starter_meadow", "wood", 520, 680, 100),
  node("res-starter_meadow-0-0-fiber-1", "starter_meadow", "fiber", 1150, 920, 60),
  node("res-starter_meadow-0-0-stone-1", "starter_meadow", "stone", 2010, 620, 100),
  node("res-starter_meadow-1-0-wood-1", "starter_meadow", "wood", 450, 520, 100),
  node("res-starter_meadow-1-0-wood-2", "starter_meadow", "wood", 1750, 860, 100),
  node("res-starter_meadow-1-0-fiber-1", "starter_meadow", "fiber", 1120, 1520, 60),
  node("res-starter_meadow-2-0-hardwood-1", "starter_meadow", "hardwood", 650, 640, 140),
  node("res-starter_meadow-2-0-wood-1", "starter_meadow", "wood", 1680, 980, 100),
  node("res-starter_meadow-2-0-fiber-1", "starter_meadow", "fiber", 2140, 1570, 60),
  node("res-starter_meadow-0-1-wood-1", "starter_meadow", "wood", 740, 1180, 100),
  node("res-starter_meadow-0-1-stone-1", "starter_meadow", "stone", 1880, 660, 100),
  node("res-starter_meadow-0-1-herb-1", "starter_meadow", "herb", 1350, 2040, 35),
  node("res-starter_meadow-1-1-wood-1", "starter_meadow", "wood", 820, 820, 100),
  node("res-starter_meadow-1-1-stone-1", "starter_meadow", "stone", 1920, 1140, 100),
  node("res-starter_meadow-1-1-berry-1", "starter_meadow", "berry", 1450, 1780, 40),
  node("res-starter_meadow-2-1-berry-1", "starter_meadow", "berry", 640, 820, 40),
  node("res-starter_meadow-2-1-herb-1", "starter_meadow", "herb", 1360, 1320, 35),
  node("res-starter_meadow-2-1-stone-1", "starter_meadow", "stone", 2240, 1840, 100),
  node("res-starter_meadow-0-2-berry-1", "starter_meadow", "berry", 760, 760, 40),
  node("res-starter_meadow-0-2-herb-1", "starter_meadow", "herb", 1560, 1040, 35),
  node("res-starter_meadow-0-2-fiber-1", "starter_meadow", "fiber", 2040, 1980, 60),
  node("res-starter_meadow-1-2-stone-1", "starter_meadow", "stone", 700, 720, 100),
  node("res-starter_meadow-1-2-ore-1", "starter_meadow", "ore", 1720, 980, 120),
  node("res-starter_meadow-1-2-wood-1", "starter_meadow", "wood", 2240, 1680, 100),
  node("res-starter_meadow-2-2-stone-1", "starter_meadow", "stone", 620, 700, 100),
  node("res-starter_meadow-2-2-ore-1", "starter_meadow", "ore", 1420, 1220, 120),
  node("res-starter_meadow-2-2-hardwood-1", "starter_meadow", "hardwood", 2200, 1900, 140),
  node("res-stone_hills-0-0-stone-1", "stone_hills", "stone", 560, 680, 100),
  node("res-stone_hills-0-0-ore-1", "stone_hills", "ore", 1640, 980, 120),
  node("res-stone_hills-0-0-coal-1", "stone_hills", "coal", 2260, 1560, 100),
  node("res-stone_hills-1-0-stone-1", "stone_hills", "stone", 840, 620, 100),
  node("res-stone_hills-1-0-ore-1", "stone_hills", "ore", 1780, 1260, 120),
  node("res-stone_hills-1-0-ore-2", "stone_hills", "ore", 2350, 1880, 120),
  node("res-stone_hills-2-0-stone-1", "stone_hills", "stone", 720, 880, 100),
  node("res-stone_hills-2-0-coal-1", "stone_hills", "coal", 1580, 1180, 100),
  node("res-stone_hills-2-0-ore-1", "stone_hills", "ore", 2320, 2060, 120),
  node("res-stone_hills-0-1-stone-1", "stone_hills", "stone", 620, 760, 100),
  node("res-stone_hills-0-1-ore-1", "stone_hills", "ore", 1510, 1430, 120),
  node("res-stone_hills-0-1-coal-1", "stone_hills", "coal", 2320, 820, 100),
  node("res-stone_hills-1-1-stone-1", "stone_hills", "stone", 780, 820, 100),
  node("res-stone_hills-1-1-ore-1", "stone_hills", "ore", 1660, 1550, 120),
  node("res-stone_hills-1-1-coal-1", "stone_hills", "coal", 2240, 2260, 100),
  node("res-stone_hills-2-1-ore-1", "stone_hills", "ore", 700, 880, 120),
  node("res-stone_hills-2-1-coal-1", "stone_hills", "coal", 1560, 1340, 100),
  node("res-stone_hills-2-1-stone-1", "stone_hills", "stone", 2320, 1960, 100),
  node("res-stone_hills-0-2-stone-1", "stone_hills", "stone", 760, 820, 100),
  node("res-stone_hills-0-2-coal-1", "stone_hills", "coal", 1480, 1200, 100),
  node("res-stone_hills-0-2-ore-1", "stone_hills", "ore", 2260, 1960, 120),
  node("res-stone_hills-1-2-ore-1", "stone_hills", "ore", 700, 800, 120),
  node("res-stone_hills-1-2-ore-2", "stone_hills", "ore", 1460, 1460, 120),
  node("res-stone_hills-1-2-coal-1", "stone_hills", "coal", 2240, 2100, 100),
  node("res-stone_hills-2-2-coal-1", "stone_hills", "coal", 820, 760, 100),
  node("res-stone_hills-2-2-ore-1", "stone_hills", "ore", 1600, 1420, 120),
  node("res-stone_hills-2-2-stone-1", "stone_hills", "stone", 2300, 2180, 100),
];

export const STARTER_CREATURE_SPAWNS: CreatureSpawnDefinition[] = [
  { id: "mob-starter_meadow-0-0-leafbun-1", speciesId: "leafbun", regionId: "starter_meadow", position: { x: 900, y: 1420 }, level: 2, respawnMs: 25_000, traitIds: ["nimble"] },
  { id: "mob-starter_meadow-1-0-leafbun-1", speciesId: "leafbun", regionId: "starter_meadow", position: { x: 1320, y: 980 }, level: 3, respawnMs: 25_000, traitIds: ["hard_worker"] },
  { id: "mob-starter_meadow-2-0-sparkit-1", speciesId: "sparkit", regionId: "starter_meadow", position: { x: 1640, y: 1500 }, level: 4, respawnMs: 35_000, traitIds: ["brave"] },
  { id: "mob-starter_meadow-0-1-leafbun-1", speciesId: "leafbun", regionId: "starter_meadow", position: { x: 1200, y: 1620 }, level: 2, respawnMs: 25_000, traitIds: ["nimble"] },
  { id: "mob-starter_meadow-1-1-droplet-1", speciesId: "droplet", regionId: "starter_meadow", position: { x: 1760, y: 1420 }, level: 3, respawnMs: 30_000, traitIds: ["sturdy"] },
  { id: "mob-starter_meadow-2-1-droplet-1", speciesId: "droplet", regionId: "starter_meadow", position: { x: 960, y: 1380 }, level: 4, respawnMs: 30_000, traitIds: ["sturdy"] },
  { id: "mob-starter_meadow-0-2-leafbun-1", speciesId: "leafbun", regionId: "starter_meadow", position: { x: 1100, y: 1160 }, level: 3, respawnMs: 25_000, traitIds: ["hard_worker"] },
  { id: "mob-starter_meadow-1-2-sparkit-1", speciesId: "sparkit", regionId: "starter_meadow", position: { x: 1660, y: 1680 }, level: 5, respawnMs: 35_000, traitIds: ["brave"] },
  { id: "mob-starter_meadow-2-2-mossboar-1", speciesId: "mossboar", regionId: "starter_meadow", position: { x: 1580, y: 1480 }, level: 7, respawnMs: 45_000, traitIds: ["sturdy", "hard_worker"] },
  { id: "mob-stone_hills-0-0-rockturtle-1", speciesId: "rockturtle", regionId: "stone_hills", position: { x: 1380, y: 1220 }, level: 9, respawnMs: 45_000, traitIds: ["sturdy"] },
  { id: "mob-stone_hills-1-0-moleminer-1", speciesId: "moleminer", regionId: "stone_hills", position: { x: 1620, y: 1360 }, level: 11, respawnMs: 45_000, traitIds: ["hard_worker"] },
  { id: "mob-stone_hills-2-0-sparkit-1", speciesId: "sparkit", regionId: "stone_hills", position: { x: 1120, y: 1660 }, level: 8, respawnMs: 35_000, traitIds: ["tireless"] },
  { id: "mob-stone_hills-0-1-rockturtle-1", speciesId: "rockturtle", regionId: "stone_hills", position: { x: 1250, y: 1720 }, level: 10, respawnMs: 45_000, traitIds: ["giant_body"] },
  { id: "mob-stone_hills-1-1-moleminer-1", speciesId: "moleminer", regionId: "stone_hills", position: { x: 1700, y: 1500 }, level: 12, respawnMs: 45_000, traitIds: ["sturdy"] },
  { id: "mob-stone_hills-2-1-rockturtle-1", speciesId: "rockturtle", regionId: "stone_hills", position: { x: 1840, y: 1220 }, level: 11, respawnMs: 45_000, traitIds: ["giant_body"] },
  { id: "mob-stone_hills-0-2-sparkit-1", speciesId: "sparkit", regionId: "stone_hills", position: { x: 1100, y: 1380 }, level: 9, respawnMs: 35_000, traitIds: ["brave"] },
  { id: "mob-stone_hills-1-2-rockturtle-1", speciesId: "rockturtle", regionId: "stone_hills", position: { x: 1540, y: 1600 }, level: 12, respawnMs: 45_000, traitIds: ["giant_body"] },
  { id: "mob-stone_hills-2-2-moleminer-1", speciesId: "moleminer", regionId: "stone_hills", position: { x: 1740, y: 1480 }, level: 14, respawnMs: 45_000, traitIds: ["hard_worker", "sturdy"] },
];
