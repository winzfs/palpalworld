...
export const REGION_THEMES = {
  ...
  moss_forest: {
    regionId: "moss_forest",
    name: "이끼 숲 지대",
    description: "짙은 이끼와 오래된 나무가 많은 숲 지역입니다.",
    columns: 3,
    rows: 3,
  },
  stone_hills: {
  ...
  ember_desert: {
    regionId: "ember_desert",
    name: "잿불 사막 지대",
    description: "뜨거운 모래와 잿불 조각이 흩어진 사막 지역입니다.",
    columns: 3,
    rows: 3,
  },
  frost_peaks: {
    regionId: "frost_peaks",
    name: "서리 봉우리 지대",
    description: "얼음 결정과 차가운 절벽이 이어진 설산 지역입니다.",
    columns: 3,
    rows: 3,
  },
