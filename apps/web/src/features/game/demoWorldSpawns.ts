...
const resourcePositions = [
  { x: 210, y: 250 }, { x: 470, y: 390 }, { x: 760, y: 230 }, { x: 1050, y: 460 }, { x: 1320, y: 280 }, { x: 1630, y: 520 },
  { x: 1940, y: 300 }, { x: 2260, y: 500 }, { x: 2580, y: 270 }, { x: 2820, y: 660 }, { x: 270, y: 820 }, { x: 620, y: 740 },
  { x: 940, y: 900 }, { x: 1240, y: 760 }, { x: 1520, y: 980 }, { x: 1840, y: 820 }, { x: 2160, y: 1040 }, { x: 2480, y: 900 },
  { x: 2780, y: 1160 }, { x: 350, y: 1320 }, { x: 720, y: 1480 }, { x: 1080, y: 1280 }, { x: 1420, y: 1550 }, { x: 1760, y: 1350 },
  { x: 2100, y: 1580 }, { x: 2460, y: 1420 }, { x: 2800, y: 1740 }, { x: 260, y: 1960 }, { x: 570, y: 2140 }, { x: 910, y: 1900 },
  { x: 1260, y: 2220 }, { x: 1600, y: 2020 }, { x: 1940, y: 2300 }, { x: 2280, y: 2100 }, { x: 2620, y: 2380 }, { x: 360, y: 2660 },
  { x: 740, y: 2520 }, { x: 1110, y: 2760 }, { x: 1480, y: 2580 }, { x: 1860, y: 2760 }, { x: 2240, y: 2580 }, { x: 2680, y: 2740 },
] as const;

const creaturePositions = [
  { x: 430, y: 610 }, { x: 1040, y: 620 }, { x: 1680, y: 600 }, { x: 2320, y: 620 }, { x: 720, y: 1080 }, { x: 1360, y: 1140 },
  { x: 2060, y: 1120 }, { x: 2680, y: 1240 }, { x: 470, y: 1660 }, { x: 1110, y: 1740 }, { x: 1760, y: 1680 }, { x: 2440, y: 1780 },
  { x: 720, y: 2320 }, { x: 1360, y: 2460 }, { x: 2040, y: 2320 }, { x: 2660, y: 2520 },
] as const;
...
function offsetPosition(position: { x: number; y: number }, tileX: number, tileY: number, index: number) {
  ...
  return { x: Math.max(160, Math.min(2840, position.x + jitterX)), y: Math.max(160, Math.min(2840, position.y + jitterY)) };
}
...
function makeResource(regionId: string, tileX: number, tileY: number, index: number): ResourceNodeState {
  ...
  return { id: `res-${regionId}-${tileX}-${tileY}-${resourceType}-ultra-${index}`, regionId, resourceType, position: offsetPosition(base, tileX, tileY, index), currentTile, remainingAmount: amount, maxAmount: amount } as ResourceNodeState;
}
