  ...
  return (
    <div className="minimap-panel">
      ...
      <style>{`
        ...
        .minimap-dot--player { width: 13px; height: 13px; background: #facc15; border: 2px solid #fff7ed; z-index: 6; box-shadow: 0 0 0 2px rgba(15,23,42,.9), 0 0 16px rgba(250,204,21,.75); }
